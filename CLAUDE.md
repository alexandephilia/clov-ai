...
> **Note**: If clov is installed, prefer `clov <cmd>` over raw commands for token-optimized output.
> All commands work with passthrough support even for subcommands clov doesn't specifically handle.

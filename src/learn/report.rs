...
pub fn format_console_report(
    ...
    output.push_str(&format!(
        "CLOV Learn -- {} rules from {} corrections ({} sessions, {} days)\n",
        rules.len(),
        total_corrections,
        sessions,
        days
...
pub fn write_rules_file(rules: &[CorrectionRule], path: &str) -> Result<()> {
    ...
    content.push_str("# CLI Corrections (auto-generated by clov adapt)\n");
    content.push_str("# Run `clov adapt --write-rules` to update\n\n");

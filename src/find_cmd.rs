...
/// Parse arguments from raw args vec, supporting both native find and CLOV syntax.
///
/// Native find syntax: `find . -name "*.rs" -type f -maxdepth 3`
/// CLOV syntax: `find *.rs [path] [-m max] [-t type]`
